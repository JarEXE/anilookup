...
export default function TopPublishing({ isDarkMode, allowNSFW }) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://api.jikan.moe/v4/top/manga?filter=publishing&limit=24${
...
export function TopManhwa({ isDarkMode, allowNSFW }) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://api.jikan.moe/v4/top/manga?type=manhwa&limit=24${
          // eslint-disable-next-line
          sfwToggle == 1 ? "&" : "&sfw"
        }`
      )
...
export function TopManhua({ isDarkMode, allowNSFW }) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://api.jikan.moe/v4/top/manga?type=manhua&limit=24${
          // eslint-disable-next-line
          sfwToggle == 1 ? "&" : "&sfw"
        }`
      )
...
export function TopManga({ isDarkMode, allowNSFW }) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://api.jikan.moe/v4/top/manga?type=manga&limit=24${
          // eslint-disable-next-line
          sfwToggle == 1 ? "&" : "&sfw"
        }`
      )
...
export function TopNovel({ isDarkMode, allowNSFW }) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(
        `https://api.jikan.moe/v4/top/manga?type=novel&limit=24${
          // eslint-disable-next-line
          sfwToggle == 1 ? "&" : "&sfw"
        }`
      )
...
export function TopDoujin({ isDarkMode, allowNSFW }) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`https://api.jikan.moe/v4/top/manga?type=doujin&limit=24`)
      .then((response) => {
        const animes = response.data.data;
